...
public class ViewEditServlet extends HttpServlet {
    ...
    /**
     * Handles POST requests for updating records.
     * It determines which type of record is being updated based on the non-null primary key fields.
     */
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            } else if (vehicleRegId != null && !vehicleRegId.isEmpty()) {
