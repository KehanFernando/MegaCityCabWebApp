...
public class CarRegistrationDAO {
    ...
    /**
     * Deletes a vehicle record from the database based on vehicleRegId.
     *
     * @param vehicleRegId the vehicle's registration id.
     * @return true if deletion was successful, false otherwise.
     */
    public boolean deleteVehicle(String vehicleRegId) {
        String sql = "DELETE FROM vehicles WHERE vehicleRegId = ?";
        try (Connection conn = DBConnectionManager.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
